...
<html lang="">
  <head>
    ...
    <script src="js/sysadmin/date.js"></script>
        ...
        <div id="topbar" class="hoc clear sysadmin_topbar">
          <div class="fl_left">
            <div class="sysadmin_logo">
              <img id="admin_logo" src="views/images/logo.png" alt="sysadmin_logo" />
            </div>
          </div>
          <div class="fl_right">
            <ul class="nospace">
              ...
              <li>
                <h3 class="topbar_username"><?php echo $_SESSION['role'] == 100 ? 'Super Admin' : $_SESSION['user_fullname'] ?></h3>
              </li>
              <li>
                <div class="user_box">
